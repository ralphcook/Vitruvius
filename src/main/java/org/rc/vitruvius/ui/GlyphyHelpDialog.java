 ...
 * <P>The text is read from a file; the filename is indexed in the Resources properties
 * file so that it can be translated for a default locale.
 * 
 * @see org.rc.vitruvius.ui.I18N
 * @author rcook
 *
 */
public class GlyphyHelpDialog extends JDialog
{
